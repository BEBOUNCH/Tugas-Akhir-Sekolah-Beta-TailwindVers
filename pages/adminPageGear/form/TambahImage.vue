  ...
  <div class="container py-24 mx-auto w-3/4 flex flex-wrap">
    <div class="w-full mb-10">
      <form ref="imageForm" enctype="multipart/form-data" @submit.prevent="onFormSubmit">
        <label for="file" class="text-primary text-base font-semibold">Upload Image:</label>
        <br>
    ...
    <div class="w-full">
      <form @submit.prevent="onFormDelete">
        <label for="img" class="text-primary text-base font-semibold">Delete Image:</label>
        <br>
